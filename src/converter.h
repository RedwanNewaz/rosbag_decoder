...
{
public:
  converter(int row, int col, string &filename, string & nodename);
  ~converter();
...
public:
  can_converter(int row, int col, string &nodename);
  ~can_converter();
  void print();
  void write_video();
...
private:
  ...
  ros::NodeHandle nh;
public:
  img_converter(int row,int col, string &nodename);
  ~img_converter();
  void print();
...
private:
    ...
    ros::NodeHandle nh;
public:
  cloud_converter(int row, int col, string &nodename);
  ~cloud_converter();
